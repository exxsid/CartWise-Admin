        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        <div class="text-left">
                            <h1 class="h4 text-gray-900 mb-4">Sign Up Now</h1>
                        ...
                        <form class="user">
                            ...
                            <div class="form-group">
                                <input type="phone number" class="form-control form-control-user" id="exampleInputPhonenumber" placeholder="Phone Number">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="text-center">
                            <a class="small" href="login.php">You own grocery store? Register here</a>
                        </div>
                    </div>
                </div>
            </div>
